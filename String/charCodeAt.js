 ...
 * Якщо index менше за 0 або більший за довжину рядка то поверне NaN!!!
 * return значення Юнікода.
 */
...
console.log(str.charCodeAt('gbghnnhb'));// '72'
...
console.log(str.charCodeAt(4));// '11'
console.log(str.charCodeAt(5));// '32' - space
console.log(str.charCodeAt(6));// '119'
console.log(str.charCodeAt(7));// '111'
console.log(str.charCodeAt(8));// '114'
console.log(str.charCodeAt(9));// '100'
console.log(str.charCodeAt(10));// '33'
