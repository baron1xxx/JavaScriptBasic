// parseFloat - перевіряє чи передане значення є цілим числом і повертає true або false.
// Конвертує в стрічку, а потів стрічку в число до того моменту поки можна це зробити.
// parseFloat(' 9.89nhnhn') // 9 пробіл не врахується і поверне 9.
// parseFloat('7mhjmj,mhjmb') // поверне 7.
